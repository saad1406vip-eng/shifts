...
// ==========================================
// دالة تصدير الجدول إلى Excel (بصيغة xlsx)
// ==========================================
function exportToExcel() {
    ...
    // إضافة ورقة ثانية للرموز والتوقيعات
    const legendData = [
        ["Shift Codes:"],
