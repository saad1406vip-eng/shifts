...
// ترتيب الموظفين (يُحفظ في localStorage)
...
function renderOrderList() {
    ...
    // ترتيب الموظفين حسب الترتيب المحفوظ أو حسب القائمة الأصلية
    ...
    sortedEmployees.forEach((emp, index) => {
        ...
        div.innerHTML = `
            ...
            <input type="number" min="1" max="18" value="${currentOrder}" 
...
function applyOrder() {
    // إعادة ترتيب مصفوفة الموظفين بناءً على الأرقام
